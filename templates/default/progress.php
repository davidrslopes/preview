  ...
  <div class="row">
      <article class="col-12">
          ...
          <div class="example-block">
              ...
              <div id="example-caption-2" class="text-center">Reticulating splines&hellip; 25%</div>
              <div class="progress">
                  <div class="progress-bar w-25" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div id="example-caption-3" class="text-center">Reticulating splines&hellip; 50%</div>
              <div class="progress">
